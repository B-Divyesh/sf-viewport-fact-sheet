const CACHE = 'viewport-fact-sheet-v4';
const SHELL = ['/', '/demo/', '/404.html', '/assets/viewport-blueprint-hero-mobile.20260828.webp', '/assets/viewport-blueprint-hero.20260828.webp', '/privacy/', '/terms/'];
